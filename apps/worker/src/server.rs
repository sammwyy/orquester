...
pub fn build_router(state: AppState) -> Router {
    let mut router = Router::new()
        ...
        .route("/api/system/battery", get(routes::system::battery))
        .route("/api/system/resources", get(routes::system::resources))
        .route("/api/system/media", get(routes::system::media))
        .route("/api/system/media/thumbnail", get(routes::system::media_thumbnail))
        .route("/api/system/media/control", post(routes::system::media_control))
        .route("/api/system/networking", get(routes::system::networking))
        .route("/api/system/networking/kill", post(routes::system::networking_kill))
